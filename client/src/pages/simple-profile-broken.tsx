          ...
          <Card>
                  ...
                  {!isEditing ? (
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button
                        ...
                        disabled={updateRoleMutation.isPending || updateInputPreferenceMutation.isPending}
                      >
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                    ...
                    <div className="flex space-x-2">
                      <Button
                        onClick={() => {
                          ...
                          if (newEmail !== (user as any)?.email) updateData.email = newEmail;
                          if (newPhone !== (user as any)?.phone) updateData.phone = newPhone;
                    ...
                    {(user as any)?.email ? (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="text-sm font-medium">{(user as any).email}</div>
                        ...
                        {!(user as any)?.isEmailVerified && !showEmailVerification && (
                          <Button
                            size="sm"
                    ...
                    {(user as any)?.phone ? (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="text-sm font-medium">{(user as any).phone}</div>
                            <div className="text-xs text-gray-500">
                              {isUpdatingProfile ? (
                                <Badge variant="outline" className="text-blue-700 bg-blue-50">
                                  <Loader2 className="h-3 w-3 animate-spin mr-1" />
                        ...
                        {!(user as any)?.isPhoneVerified && !showPhoneVerification && (
                          <Button
                            size="sm"
                ...
                {showEmailVerification && (
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-xs text-blue-700 mb-3">
                      Enter the verification code sent to {(user as any)?.email}
                    </p>
                    <div className="flex space-x-2">
                      <Input
                ...
                {showPhoneVerification && (
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-xs text-blue-700 mb-3">
                      Enter the verification code sent to {(user as any)?.phone}
                    </p>
                    <div className="flex space-x-2">
                      <Input
                        placeholder="Enter 6-digit code"
              ...
              <div>
                ...
                {isEditing ? (
                  <Select value={selectedRole || (user as any)?.roleId?.toString() || ""} onValueChange={setSelectedRole}>
                    <SelectTrigger>
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm font-medium">{getCurrentRoleName()}</div>
                  </div>
                )}
              </div>
              ...
              {/* Input Preference */}
              <div>
                <h3 className="text-sm font-medium text-gray-700 mb-3">Input Preference</h3>
                {isEditing ? (
                  <Select 
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <div className="text-sm font-medium">
                      {(user as any)?.inputPreference === "VOICE" ? "Voice" : "Keyboard"}
                    </div>
                  </div>
                )}
              </div>
