...
export class DatabaseStorage implements IStorage {
  ...
  async getConversationHistory(threadId: string): Promise<any[]> {
    ...
    try {
      ...
      if (result.rows.length > 0) {
        ...
        const userMessages = result.rows.filter(
          (row) => row.messagetype === 'user',
        );
        const systemMessages = result.rows.filter(
          (row) => row.messagetype === 'system',
        );

        // Pair user messages with system responses
        for (
          let i = 0;
          i < Math.max(userMessages.length, systemMessages.length);
          i++
        ) {
      ...
      console.error(
        'Error retrieving conversation history from database:',
        error,
      );
    }
      ...
      thread_1749320831045_2ybtrfijb: [
        {
          ...
          userid: 'system',
          userPrompt:
            'I need to find replacement parts for a faulty landing gear lock actuator.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            "To find the correct replacement parts, I'll need your aircraft model and serial number. Landing gear lock actuators are typically sourced from the original equipment manufacturer or approved repair stations.",
        ...
        },
        {
          ...
          userid: 'system',
          userPrompt:
            'The aircraft is a Cessna 172, tail number N12345. The lock actuator part number is 1234567-001.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'For Cessna 172 lock actuator part 1234567-001, check with Cessna Parts Distribution or authorized dealers. Alternative sources include Aircraft Spruce, Wentworth Aircraft, and local Cessna service centers. Ensure any replacement meets airworthiness standards.',
      ...
      thread_1749320220443_sglvgeytt: [
        {
          ...
          userid: 'system',
          userPrompt:
            "We're experiencing hydraulic pressure warnings during landing gear retraction.",
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'Hydraulic pressure warnings during gear retraction could indicate several issues. First, check hydraulic fluid levels and look for external leaks. Also verify pump operation and filter condition.',
        ...
        },
        {
          ...
          userid: 'system',
          userPrompt:
            'Fluid levels are normal, no visible leaks. The pump seems to run longer than usual.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            "Extended pump runtime suggests the system isn't building pressure efficiently. Check the hydraulic filter for contamination and inspect the relief valve. You may need to perform a system pressure test.",
      ...
      thread_1749320233542_oel8j9uik: [
        {
          ...
          userid: 'system',
          userPrompt:
            'Need help troubleshooting engine vibration during startup sequence.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'Engine vibration during startup can indicate several issues. Check engine mounts, propeller balance, and fuel system priming. What type of aircraft and engine are you working with?',
        ...
        },
        {
          ...
          userid: 'system',
          userPrompt:
            "It's a Piper Cherokee with a Lycoming O-320. The vibration starts immediately after engine start.",
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            "For Lycoming O-320 startup vibration, check the engine mounts first - they're common failure points on Cherokees. Also inspect the propeller for nicks or imbalance, and verify proper fuel flow to all cylinders.",
      ...
      thread_1749320888762_tdixeq06m: [
        {
          ...
          userid: 'system',
          userPrompt:
            'Radio communication cutting out intermittently during flight operations.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'Intermittent radio issues often stem from antenna connections, power supply voltage fluctuations, or internal radio component failures. Have you checked the antenna connections and power supply?',
        ...
        },
        {
          ...
          userid: 'system',
          userPrompt:
            'Antenna connections look good, and voltage is steady at 14.2V. The cutouts seem random.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'With good connections and stable power, this points to internal radio failure. Check for loose internal connections, especially at the microphone jack and audio circuits. May require radio shop diagnosis.',
      ...
      thread_1749345654345_s7w5j25ad: [
        {
          ...
          userid: 'system',
          userPrompt:
            'Aircraft compass showing significant deviation during taxi operations.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'Compass deviation during taxi often indicates magnetic interference or the need for compass swing calibration. Have you noticed this on a specific runway or throughout the airport?',
        ...
        },
        {
          ...
          userid: 'system',
          userPrompt:
            'The deviation appears worse near the maintenance hangar and electrical equipment areas.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'This confirms magnetic interference from ground equipment. The compass may need recalibration away from these areas. Schedule a compass swing at a designated compass rose location.',
      ...
      thread_1749452544192_kpii8f7i1: [
        {
          ...
          userid: 'system',
          userPrompt:
            'Brake pedal feels spongy during pre-flight inspection and taxi.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            'Spongy brake pedals typically indicate air in the brake system or low brake fluid levels. Check the brake fluid reservoir and look for any signs of leakage around brake lines.',
        ...
        },
        {
          ...
          userid: 'system',
          userPrompt:
            'Brake fluid level appears normal, but I noticed some moisture around the left main gear brake line.',
          agentResponse: null,
        ...
        },
        {
          ...
          userPrompt: null,
          agentResponse:
            "Moisture around brake lines suggests a leak that's allowing air into the system. This requires immediate attention - do not fly until the brake system is inspected and repaired by a certified mechanic.",
  ...
  async saveConversationMessage(
    ...
    try {
      ...
      console.log(
        'conversation_history table columns in Azure DB:',
        columnResult.rows,
      );

      // Check if table has the expected columns, if not drop and recreate
      const hasThreadId = columnResult.rows.some(
        (row) => row.column_name === 'threadid',
      );
      if (!hasThreadId) {
        console.log(
          'Recreating conversation_history table with correct structure',
        );
        ...
        console.log(
          'Created conversation_history table with correct structure',
        );
      }
      ...
      console.log(
        'Successfully saved conversation message to database:',
        result.rows[0],
      );
  ...
  async saveSummary(summary: InsertSummary): Promise<ConversationSummary> {
    ...
    try {
      ...
      console.log(
        'Storage: Successfully saved summary via direct SQL:',
        savedSummary,
      );
